...
import { Sparkles, Twitter, Github, Mail, CheckCircle, AlertCircle, Loader2 } from "lucide-react";
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="md:col-span-2 space-y-6">
                        ...
                        <div className="flex gap-4">
                            <a href="https://twitter.com/vibestack" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-sm text-muted-foreground">
                            ...
                            <li><Link href="#" className="hover:text-primary transition-colors">Get Featured</Link></li>
                        </ul>
                    </div>
