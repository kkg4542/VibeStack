...
export function AuthDialog({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[400px] border-border bg-popover/90 backdrop-blur-xl p-8">
                ...
                <div className="grid gap-3">
                    <Button
                        ...
                        disabled={isLoading}
                        className="h-11 relative overflow-hidden transition-all hover:bg-foreground/5 hover:border-border"
                    >
