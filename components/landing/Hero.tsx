...
export function Hero() {
    return (
        <section className="relative flex min-h-[80vh] flex-col items-center justify-center overflow-hidden border-b border-border/40 bg-background pt-32 md:pt-40">
            {/* Background Glow */}
            <div className="absolute top-0 z-0 h-[50vh] w-full bg-indigo-500/10 blur-[120px]" />
            ...
            <div className="relative z-10 flex max-w-[980px] flex-col items-center gap-6 px-4 text-center">
                <motion.div
                    ...
                    className="inline-flex items-center rounded-full border border-indigo-500/30 bg-indigo-500/10 px-3 py-1 text-sm text-indigo-300 backdrop-blur-sm"
                >
