...
export function Hero() {
    return (
        <section className="relative flex min-h-[80vh] flex-col items-center justify-center overflow-hidden border-b border-border/40 bg-background pt-32 md:pt-40">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 z-0 h-[60vh] w-full max-w-[1200px] bg-indigo-500/10 dark:bg-indigo-500/20 blur-[140px] rounded-full" />
            ...
            <div className="relative z-10 flex max-w-[980px] flex-col items-center gap-6 px-4 text-center">
                ...
                <motion.h1
                    ...
                    className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl md:text-7xl lg:text-8xl"
                >
                ...
                >
                    <Link
                        ...
                        className={buttonVariants({ variant: "default", size: "lg" }) + " h-14 rounded-full px-10 text-base font-semibold shadow-xl shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-0.5 transition-all duration-300 group"}
                    >
                        Start Building
                    ...
                    <Link
                        ...
                        className={buttonVariants({ variant: "outline", size: "lg" }) + " h-14 rounded-full border-border/60 bg-background/50 px-10 text-base backdrop-blur-md hover:bg-accent/50 hover:-translate-y-0.5 transition-all duration-300"}
                    >
                        Explore Tools
                    </Link>
                </motion.div>
