export function BackgroundGlows() {
    return (
        <>
            <div className="absolute top-0 left-1/2 -translate-x-1/2 z-0 h-[60vh] w-full max-w-[1200px] bg-primary/5 dark:bg-primary/10 blur-[80px] rounded-full will-change-transform" />
            <div className="absolute top-[30%] left-[15%] z-0 h-[25vh] w-[25vh] bg-vibe-purple/5 blur-[60px] rounded-full" />
