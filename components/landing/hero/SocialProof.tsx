        ...
        >
            <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                    <div
                        key={i}
                        className="w-8 h-8 rounded-full bg-linear-to-br from-vibe-electric to-vibe-purple border-2 border-background flex items-center justify-center text-[10px] font-bold text-vibe-deep"
                    >
