 ...
 */
export const BEST_REVISED = "2026-09-22";
...
export const BEST_CATEGORIES: CategoryCopy[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "If you landed here from a link to Sora or Galileo AI, both were retired from this directory. OpenAI discontinued the Sora web and app experiences on April 26, 2026, and is shutting down the Sora API on September 24, 2026, with no replacement model. Galileo AI's text-to-UI product now redirects to Google Stitch. Our <a href=\"/blog/discontinued-ai-tools-2026\">rundown of discontinued AI tools in 2026</a> covers what happened to each.",
    ],
    buyingGuide: [
