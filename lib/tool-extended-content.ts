...
export const TOOL_EXTENDED_CONTENT: Record<string, ToolExtendedContent> = {
    ...
    "gemini-code-assist": {
        overviewHtml: `
            ...
            <p>Google's own deprecation documentation is unambiguous: as of <strong>June 18, 2026</strong> the Gemini Code Assist IDE extensions stopped serving the "Gemini Code Assist for individuals", Google AI Pro, and Google AI Ultra tiers, and those users were directed to <strong>Antigravity</strong> instead. Google's overview documentation now describes Code Assist as available in two editions — Standard and Enterprise — and nothing else. The paid Standard and Enterprise tiers aimed at Google Cloud organisations were not affected by any of this. Our <a href="/blog/discontinued-ai-tools-2026">rundown of discontinued AI tools in 2026</a> has the full timeline, with the vendor's own dates.</p>
    ...
    "devin-ai": {
        overviewHtml: `
            ...
            <p>Worth settling before anything else, because the names collide and a lot of people arrive here looking for the other product. This page is about <strong>Devin</strong>, the autonomous agent. Cognition also ships <strong>Devin Desktop</strong>, which is an IDE — specifically, it is the editor Codeium built and shipped as <strong>Windsurf</strong>. Cognition acquired Windsurf from Codeium in July 2025 and relaunched it under the Devin name on June 2, 2026, describing it as the next generation of Windsurf; at launch Cognition said it remained compatible with Windsurf and VS Code extensions, keybindings, and LSP integrations. Underneath, the agent itself changed too: Cascade was replaced by Devin Local, a from-scratch Rust rewrite that Cognition says is up to 30% more token efficient. Both codeium.com and windsurf.com now redirect to devin.ai/desktop — see our <a href="/blog/discontinued-ai-tools-2026">rundown of Windsurf and four other AI tools that changed or shut down in 2026</a> for the full timeline.</p>
