    ...
    content: `
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Models</td><td>OpenAI, Anthropic, xAI (Grok added in 3.11)</td><td>OpenAI, Anthropic, and more</td></tr>
