...
export const COMPARE_EDITORIAL: Record<string, CompareEditorial> = {
  ...
  "cursor-vs-gemini-code-assist": {
    ...
    intro: [
      "Cursor and Gemini Code Assist both put AI in front of your code, but only one of them is an editor. Cursor is a VS Code fork rebuilt around AI: multi-file agent edits, codebase-wide chat, and a model picker that spans Claude, GPT, Gemini, and Grok. Gemini Code Assist is an extension — it adds Google's Gemini models to the IDE you already use, and its real differentiator is awareness of your Google Cloud resources. Since Google retired the individual tier it ships in two paid editions only, Standard and Enterprise, both aimed at Cloud organisations.",
      "Pricing is where they diverge hardest, and it's the comparison most people are actually running. Cursor charges credits: $20/mo Pro, $60 Pro+, $200 Ultra, and how far a tier stretches depends on which model you point at your prompts — frontier models burn credits fast, cheaper ones last. The capability is worth it for many developers, but you end up doing arithmetic in your head before firing off a long agent run. Gemini Code Assist used to run the opposite play, with an unusually generous free individual tier: up to 6,000 code requests and 240 chat requests per day, which for a solo developer was effectively unlimited. That is the comparison most people still have in their heads, and it no longer holds.",
      "That free tier is gone. Google's deprecation documentation confirms the Code Assist IDE extensions stopped serving the individual, Google AI Pro, and Google AI Ultra tiers as of June 18, 2026, and those users were pointed to Antigravity instead; Google now describes Code Assist as available in two editions only. So the pricing question that used to define this matchup — Cursor's metered credits against Google's free allowance — has closed. What's left is a paid editor against a paid, Cloud-oriented organization subscription: Standard (~$19–23/user/mo) and Enterprise (~$45–54/user/mo), both unaffected by the individual-tier shutdown, and both where the product's genuine strength — suggestions grounded in your actual cloud services — has always lived. Treat those per-seat figures as indicative and check Google's pricing page before budgeting.",
    ],
    verdict:
      "Choose Cursor if agentic, multi-file development is the job and you'd rather absorb variable credit costs for the most capable AI editor available. Choose Gemini Code Assist if your team builds on Google Cloud and wants an assistant that understands your infrastructure — but understand that it's an organization purchase now, not a free solo option, because the individual tier was retired in favour of Antigravity. If you're a solo developer who came for the free allowance, neither side of this comparison is free any more. They aren't really the same product either: one replaces your editor, the other adds Google's models to it.",
    faqs: [
      {
        q: "Is Gemini Code Assist still free?",
        a: "No. It had a very generous free individual tier — roughly 6,000 code requests and 240 chat requests per day — but Google's deprecation documentation confirms the Code Assist IDE extensions stopped serving individual, Google AI Pro, and Google AI Ultra accounts on June 18, 2026, migrating those users to Antigravity. Google now lists Code Assist in two editions, Standard and Enterprise, both paid and both unaffected by the shutdown. If you find a page still advertising a free individual tier with no credit card required, that's stale vendor marketing, not a plan you can sign up for.",
      },
      {
        q: "Can I use Gemini models inside Cursor?",
        a: "Yes. Cursor's model picker includes Gemini alongside Claude, GPT, and Grok, so you can get Gemini's output inside an agentic editor. The catch is that it runs on Cursor credits — you're paying Cursor for both the editor and the model access rather than buying a Code Assist seat from Google. That was a meaningful trade-off back when Google had a free allowance to undercut it; with the individual tier retired, both routes are paid.",
      },
    ],
  },
