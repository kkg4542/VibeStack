                    ...
                    <div className="grid lg:grid-cols-4 gap-8">
                        ...
                        <aside className="lg:col-span-1 space-y-6">
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                transition={{ duration: 0.6 }}
                                className="bg-linear-to-br from-indigo-500/10 via-purple-500/5 to-pink-500/10 rounded-3xl border border-indigo-500/20 p-6 backdrop-blur-sm sticky top-24"
                            >
